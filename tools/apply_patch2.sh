...
{ want folders || want ui || want status; } && check "$J/utils/DirectoryInitialization.kt" "SharedDataDirectory.resolve" "chosen data folder survives a restart"
{ want folders || want ui || want status; } && check "$J/utils/DirectoryInitialization.kt" "ensureLayout" "data folders are created at startup"
